...
test('incomplete todo should render an li without a complete class', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = `<li>Take out the trash</li>`;
    
    //Act 
    // Call the function you're testing and set the result to a const
    const actual = renderTodo({ description: 'Take out the trash', complete: false });
